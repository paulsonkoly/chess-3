...
type Counters struct {
	...
	Moves    int   // Moves is the total explored (searched) move count. Moves / ABNodes ~ avg. branching factor
	FirstCut int   // FirstCut counts how many times AB searched exactly 1 move.
}
