...
var DefaultTargets = []string{
	...
	"KingAttackPieces", "SafeChecks", "UnsafeChecks", "KingOpenFile", "KingShelter", "KingStorm", "KingAttackMagnitude",
	...
	"PawnlessFlank",
	"InsufficientKnight", "InsufficientBishop", "KRvKN", "KRvKB", "KQvKR",
}
