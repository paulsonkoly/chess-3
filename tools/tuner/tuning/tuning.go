...
var DefaultTargets = []string{
	...
	"Shelter", "SmallShelter", "InvalidShelter", "KingStorm",
	"KingAttackPieces", "SafeChecks", "UnsafeChecks", "KingOpenFile", "KingAttackMagnitude",
	...
	"PawnlessFlank",
	"InsufficientKnight", "InsufficientBishop", "KRvKN", "KRvKB",
}
