...
func TestMoves(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			fen:  "8/8/8/8/8/8/K7/7k b - - 0 1",
			want: []string{"h1h2", "h1g2", "h1g1"},
		},
		{
			name: "simple knight move",
			fen:  "8/8/8/8/8/4N3/8/k6K w - - 0 1",
		...
		},
		{
			...
			fen:  "k7/8/8/8/8/2K5/2R5/8 w - - 0 1",
			want: []string{
		...
		},
		{
			...
			fen:  "8/8/8/2k5/8/2K5/2Q5/8 w - - 0 1",
			want: []string{
		...
		{
			name: "regression #2",
			fen:  "rnbqkbnr/1ppppppp/8/p7/1P6/8/P1PPPPPP/RNBQKBNR w - - 0 1",
			want: []string{
		...
		{
			name: "regression #3",
			fen:  "rnbqkbnr/1ppppppp/8/p7/8/N6N/PPPPPPPP/R1BQKB1R b - - 0 1",
			want: []string{
		...
		{
			name: "regression #4",
			fen:  "rnbqkbnr/1ppppppp/p7/1N6/8/8/PPPPPPPP/R1BQKBNR b - - 0 1",
			want: []string{
		...
		{
			name: "regression #5",
			fen:  "rnbq3r/pp1Pbpkp/2p3p1/6P1/2B5/8/PPP1Nn1P/RNBQ1K1R b - - 0 1",
			want: []string{
		...
		{
			name: "regression #6",
			fen:  "rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPPBN1PP/R3KN1n w Q - 0 1",
			want: []string{
...
func TestGenNoisy(t *testing.T) {
	tests := []struct {
		...
		{
			name: "king captures",
			fen:  "8/8/7k/8/8/8/pK6/B7 w - - 0 1",
			want: []string{"b2a2"},
		},
		{
			name: "knight captures",
			fen:  "8/6k1/8/8/8/p7/8/1N1K4 w - - 0 1",
			want: []string{"b1a3"},
		},
		{
			name: "bishop captures",
			fen:  "K7/1B6/p6k/8/8/8/8/8 w - - 0 1",
			want: []string{"b7a6"},
		},
		{
			name: "pawn captures",
			fen:  "6k1/8/8/8/8/p2PP2P/PP3P2/KB6 w - - 0 1",
			want: []string{"b2a3"},
		},
	}
