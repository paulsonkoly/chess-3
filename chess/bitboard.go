...
// FileCluster is the group of files - either queen side, king side or central corresponding to file.
func FileCluster(file Coord) BitBoard { return fileCluster[file] }
