...
type CoeffSet[T ScoreType] struct {
	...
	// KRvKN is the socre reduction factor for the side with a rook for KRvKN endgame.
	KRvKN T
	// KRvKB is the socre reduction factor for the side with a rook for KRvKB endgame.
	KRvKB T
}
