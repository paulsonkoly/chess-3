...
var Coefficients = CoeffSet[Score]{
	PSqT: [12][64]Score{
		...
		},
		{
			...
			-22, -33, -24, -15, -31, -31, -51, -9,
		},
		{
			117, 191, 156, 97, 31, 55, 23, 151,
			-26, 93, 87, 157, 90, 90, 69, -57,
			27, 130, 119, 66, 99, 138, 91, -11,
			25, 60, 56, 25, 35, 49, 31, -46,
			-27, 16, 33, -15, 3, 2, -2, -85,
			-37, -20, -31, -31, -18, -35, -17, -50,
			19, -11, -29, -60, -54, -48, -1, 10,
			8, 39, 8, -70, -27, -66, 18, 23,
		},
		{
			-156, -92, -63, -24, -24, -28, -23, -153,
	...
	KnightOutpost: [2][40]Score{
		{
			-2, 12, 87, 27, 85, 86, 166, -43,
			64, 21, -10, -17, 26, -31, -1, -8,
			2, -5, 17, 23, 6, 36, 13, 29,
			11, 23, 28, 34, 44, 60, 55, 18,
			0, 0, 0, 33, 39, 0, 0, 0,
		},
		{
			-45, 52, 10, 14, -6, 52, -22, 28,
			-21, 8, 19, 8, 4, 28, 20, 32,
			35, 40, 22, 29, 40, 38, 46, 36,
